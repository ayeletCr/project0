  ...
  class Signup extends CI_Controller {
    ...
    public function index() {
      ...
      if ($this->form_validation->run() == FALSE) {
        $this->load->view('templates/header', array('title' => 'Signup'));
        ...
        $this->load->view('templates/header', array('title' => 'Signup Successful'));
    ...
    public function password2_check($password2, $password) {
